...
% Talk about where .vimrc is located, what you can configure with it, set
% keybindings here, add and configure plugins etc.
% Mention to start with empty .vimrc and only add settings that you know what
% you are doing.
% Read others .vimrc files to learn and try them out.
